...
public class StatPanel extends JPanel{
	...
	private JFreeChart createXYChartTraveler() {
		...
		Map<Float, Integer> data = dataStorage.getPassengerData();
		Float key;
		Integer value;
		
		for(Entry<Float, Integer> entry : data.entrySet()){ 		
		...
		return ChartFactory.createXYLineChart("Évolution du nombre de voyageur", "heure", "Nombre de voyageur total", seriesCollectionTraveler, PlotOrientation.VERTICAL, true, true, false);
	...
	private JFreeChart createXYChartSatisfaction() {
		...
		Map<Float, Integer> data = dataStorage.getSatisfactionData();
		Float key;
		Integer value;
		...
		return ChartFactory.createXYLineChart("Évolution du taux de satisfaction moyen", "heure", "Taux de satisfaction moyen", seriesCollectionSatisfaction, PlotOrientation.VERTICAL, true, true, false);
	...
	private JFreeChart createXYChartIncident() {
		...
		Map<Float, Integer> data = dataStorage.getIncidentData();
		Float key;
		Integer value;
		...
		return ChartFactory.createXYLineChart("Évolution du nombre d'incident", "heure", "Nombre d'incident", seriesCollectionIncident, PlotOrientation.VERTICAL, true, true, false);
