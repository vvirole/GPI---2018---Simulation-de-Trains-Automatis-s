...
public class SimulationData {
	...
	//nombre d'accident par type de période -> categoryChart
	...
	public void addTravelerData(int turn, int number){
	...
	public Map<Integer, Integer> getTravelerData(){
		return NbTravelerData;
	}
