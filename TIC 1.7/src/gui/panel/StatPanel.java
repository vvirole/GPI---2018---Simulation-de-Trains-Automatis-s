...
//		jbPreviousStation.addActionListener(new ActionExit());
	...
	private JFreeChart createXYChartTraveler() {
		...
		XYSeries graph = new XYSeries("Evolution du nombre de voyageur");
		Map<Integer, Integer> data = simulationData.getTravelerData();
		Integer key, value;
		...
		return ChartFactory.createXYLineChart("Évolution du nombre de voyageur", "Cycle", "Nombre de voyageur", seriesCollectionTraveler, PlotOrientation.VERTICAL, true, true, false);
	...
	private JFreeChart createXYChartSatisfaction() {
		...
		XYSeries graph = new XYSeries("Evolution du taux de satisfaction");
		Map<Integer, Integer> data = simulationData.getSatisfactionData();
		Integer key, value;
		...
		return ChartFactory.createXYLineChart("Évolution du taux de satisfaction", "Cycle", "Taux de satisfaction", seriesCollectionSatisfaction, PlotOrientation.VERTICAL, true, true, false);
